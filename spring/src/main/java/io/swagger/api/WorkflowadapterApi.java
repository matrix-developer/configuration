...
public interface WorkflowadapterApi {
    ...
    @ApiOperation(value = "getParam", nickname = "getParamUsingGET", notes = "", response = AdapterResponse.class, tags={ "work-flow-adapter-controler", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = AdapterResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/workflowadapter/getParam",
        produces = { "*/*" }, 
        consumes = { "application/json" },
        method = RequestMethod.GET)
    ResponseEntity<AdapterResponse> getParamUsingGET(@NotNull @ApiParam(value = "UID", required = true) @Valid @RequestParam(value = "UID", required = true) String UID,@NotNull @ApiParam(value = "timeout", required = true) @Valid @RequestParam(value = "timeout", required = true) String timeout);
    ...
    @ApiOperation(value = "updateVnf", nickname = "testGetUsingPOST", notes = "", response = AdapterResponse.class, tags={ "work-flow-adapter-controler", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = AdapterResponse.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/workflowadapter/testGet",
        produces = { "*/*" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<AdapterResponse> testGetUsingPOST(@NotNull @ApiParam(value = "UID", required = true) @Valid @RequestParam(value = "UID", required = true) String UID,@NotNull @ApiParam(value = "timeout", required = true) @Valid @RequestParam(value = "timeout", required = true) String timeout);
