...
public class VnfbnboardingstatusApiController implements VnfbnboardingstatusApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(VnfbnboardingstatusApiController.class);
    ...
    public VnfbnboardingstatusApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<BaseResponse> vnfbnboardingstatusGet(@NotNull @ApiParam(value = "Execution jenkins job id", required = true) @Valid @RequestParam(value = "uid", required = true) String uid) {
