...
public class VnfconfigureApiController implements VnfconfigureApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(VnfconfigureApiController.class);
    ...
    public VnfconfigureApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<BaseResponse> vnfconfigurePost(@ApiParam(value = "Execution jenkins job id") @Valid @RequestParam(value = "uid", required = false) String uid) {
