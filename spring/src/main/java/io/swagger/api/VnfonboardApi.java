...
public interface VnfonboardApi {
    ...
    @ApiOperation(value = "Inovke the jenkins vnf onboarding job", nickname = "vnfonboardPut", notes = "Inovke the jenkins vnf onboarding job", response = BaseResponse.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Onboarding status", response = BaseResponse.class) })
    @RequestMapping(value = "/vnfonboard",
        produces = { "application/json" }, 
        method = RequestMethod.PUT)
    ResponseEntity<BaseResponse> vnfonboardPut(@NotNull @ApiParam(value = "Execution jenkins job id", required = true) @Valid @RequestParam(value = "uid", required = true) String uid);
